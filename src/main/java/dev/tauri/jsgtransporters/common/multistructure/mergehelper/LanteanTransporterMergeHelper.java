...
public class LanteanTransporterMergeHelper implements IMergeHelper{
  ...
  public static final List<BlockPos> PLATFORM_POSITIONS = IntStream.rangeClosed(REAR_PYLON_OFFSET_X, -REAR_PYLON_OFFSET_X).boxed().flatMap(
    x ->
    IntStream.rangeClosed(REAR_PYLON_OFFSET_Z, FRONT_PYLON_OFFSET_Z).mapToObj(
